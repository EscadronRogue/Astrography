import { normalizeOpacitySelection, normalizePercentToUnit } from '../shared/filterValueUtils.js';
...
export function readFilterState(filterForm) {
  ...
  return {
    ...
    opacity: normalizeOpacitySelection(formData.get('opacity')),
    ...
    densityOpacity: normalizePercentToUnit(readNumericValue(formData, 'density-opacity', 100)),
    densityLineWidth: readNumericValue(formData, 'density-line-width', 30),
    densityFade: readNumericValue(formData, 'density-fade', 1),
    cloudOpacity: normalizePercentToUnit(readNumericValue(formData, 'cloud-opacity', 100)),
    cloudDensityRadius: readNumericValue(formData, 'cloud-density-radius', 5),
    cloudDensityOpacity: normalizePercentToUnit(readNumericValue(formData, 'cloud-density-opacity', 100)),
    starOpacity: normalizePercentToUnit(readNumericValue(formData, 'star-opacity', 100)),
    starNameOpacity: normalizePercentToUnit(readNumericValue(formData, 'star-name-opacity', 100)),
    connectionOpacity: normalizePercentToUnit(readNumericValue(formData, 'connection-opacity', 50), 0.5),
    ...
    constellationLineOpacity: normalizePercentToUnit(readNumericValue(formData, 'constellation-line-opacity', 40), 0.4),
    constellationLineWidth: readNumericValue(formData, 'constellation-line-width', 1),
    constellationNameOpacity: normalizePercentToUnit(readNumericValue(formData, 'constellation-name-opacity', 80), 0.8),
    planeOpacity: normalizePercentToUnit(readNumericValue(formData, 'plane-opacity', 50), 0.5),
    mollweideBorderWidth: readNumericValue(formData, 'mollweide-border-width', 1),
    mollweideBorderOpacity: normalizePercentToUnit(readNumericValue(formData, 'mollweide-border-opacity', 100)),
