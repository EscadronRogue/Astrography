...
export function readFilterState(filterForm) {
  ...
  return {
    ...
    densityOpacity: readNumericValue(formData, 'density-opacity', 100),
    densityLineWidth: readNumericValue(formData, 'density-line-width', 30),
    densityFade: readNumericValue(formData, 'density-fade', 1),
    cloudOpacity: readNumericValue(formData, 'cloud-opacity', 100),
    cloudDensityRadius: readNumericValue(formData, 'cloud-density-radius', 5),
    cloudDensityOpacity: readNumericValue(formData, 'cloud-density-opacity', 100),
    starOpacity: readNumericValue(formData, 'star-opacity', 100),
    starNameOpacity: readNumericValue(formData, 'star-name-opacity', 100),
    connectionOpacity: readNumericValue(formData, 'connection-opacity', 50),
    ...
    constellationLineOpacity: readNumericValue(formData, 'constellation-line-opacity', 40),
    constellationLineWidth: readNumericValue(formData, 'constellation-line-width', 1),
    constellationNameOpacity: readNumericValue(formData, 'constellation-name-opacity', 80),
    planeOpacity: readNumericValue(formData, 'plane-opacity', 50),
    mollweideBorderWidth: readNumericValue(formData, 'mollweide-border-width', 1),
    mollweideBorderOpacity: readNumericValue(formData, 'mollweide-border-opacity', 100),
