...
Object.defineProperties(state, {
  cachedStars: { get: () => cachedStars, set: v => { cachedStars = v; }, enumerable: true },
  currentFilteredStars: { get: () => currentFilteredStars, set: v => { currentFilteredStars = v; }, enumerable: true },
  currentConnections: { get: () => currentConnections, set: v => { currentConnections = v; }, enumerable: true },
  currentGlobeFilteredStars: { get: () => currentGlobeFilteredStars, set: v => { currentGlobeFilteredStars = v; }, enumerable: true },
  currentGlobeConnections: { get: () => currentGlobeConnections, set: v => { currentGlobeConnections = v; }, enumerable: true },
  currentMollweideFilteredStars: { get: () => currentMollweideFilteredStars, set: v => { currentMollweideFilteredStars = v; }, enumerable: true },
  currentMollweideConnections: { get: () => currentMollweideConnections, set: v => { currentMollweideConnections = v; }, enumerable: true },
  selectedStarData: { get: () => selectedStarData, set: v => { selectedStarData = v; }, enumerable: true },
  selectedHighlightTrue: { get: () => selectedHighlightTrue, set: v => { selectedHighlightTrue = v; }, enumerable: true },
  selectedHighlightGlobe: { get: () => selectedHighlightGlobe, set: v => { selectedHighlightGlobe = v; }, enumerable: true },
  selectedHighlightMollweide: { get: () => selectedHighlightMollweide, set: v => { selectedHighlightMollweide = v; }, enumerable: true },
  constellationLinesGlobe: { get: () => constellationLinesGlobe, set: v => { constellationLinesGlobe = v; }, enumerable: true },
  constellationLabelsGlobe: { get: () => constellationLabelsGlobe, set: v => { constellationLabelsGlobe = v; }, enumerable: true },
  constellationOverlayGlobe: { get: () => constellationOverlayGlobe, set: v => { constellationOverlayGlobe = v; }, enumerable: true },
  constellationLinesMoll: { get: () => constellationLinesMoll, set: v => { constellationLinesMoll = v; }, enumerable: true },
  constellationLabelsMoll: { get: () => constellationLabelsMoll, set: v => { constellationLabelsMoll = v; }, enumerable: true },
  constellationOverlayMoll: { get: () => constellationOverlayMoll, set: v => { constellationOverlayMoll = v; }, enumerable: true },
  globeSurfaceSphere: { get: () => globeSurfaceSphere, set: v => { globeSurfaceSphere = v; }, enumerable: true },
  isolationOverlay: { get: () => isolationOverlay, set: v => { isolationOverlay = v; }, enumerable: true },
  densityOverlay: { get: () => densityOverlay, set: v => { densityOverlay = v; }, enumerable: true },
  cloudDensityOverlays: { get: () => cloudDensityOverlays, set: v => { cloudDensityOverlays = v; }, enumerable: true },
  galacticPlaneTrue: { get: () => galacticPlaneTrue, set: v => { galacticPlaneTrue = v; }, enumerable: true },
  eclipticPlaneTrue: { get: () => eclipticPlaneTrue, set: v => { eclipticPlaneTrue = v; }, enumerable: true },
  celestialEquatorTrue: { get: () => celestialEquatorTrue, set: v => { celestialEquatorTrue = v; }, enumerable: true },
  galacticPlaneGlobe: { get: () => galacticPlaneGlobe, set: v => { galacticPlaneGlobe = v; }, enumerable: true },
  eclipticPlaneGlobe: { get: () => eclipticPlaneGlobe, set: v => { eclipticPlaneGlobe = v; }, enumerable: true },
  celestialEquatorGlobe: { get: () => celestialEquatorGlobe, set: v => { celestialEquatorGlobe = v; }, enumerable: true },
  galacticPlaneMoll: { get: () => galacticPlaneMoll, set: v => { galacticPlaneMoll = v; }, enumerable: true },
  eclipticPlaneMoll: { get: () => eclipticPlaneMoll, set: v => { eclipticPlaneMoll = v; }, enumerable: true },
  celestialEquatorMoll: { get: () => celestialEquatorMoll, set: v => { celestialEquatorMoll = v; }, enumerable: true },
  galacticDirectionLabelsTrue: { get: () => galacticDirectionLabelsTrue, set: v => { galacticDirectionLabelsTrue = v; }, enumerable: true },
  galacticDirectionLabelsGlobe: { get: () => galacticDirectionLabelsGlobe, set: v => { galacticDirectionLabelsGlobe = v; }, enumerable: true },
  galacticDirectionLabelsMoll: { get: () => galacticDirectionLabelsMoll, set: v => { galacticDirectionLabelsMoll = v; }, enumerable: true },
  showConstellationBoundariesFlag: { get: () => showConstellationBoundariesFlag, set: v => { showConstellationBoundariesFlag = v; }, enumerable: true },
  showConstellationNamesFlag: { get: () => showConstellationNamesFlag, set: v => { showConstellationNamesFlag = v; }, enumerable: true },
  showConstellationOverlayFlag: { get: () => showConstellationOverlayFlag, set: v => { showConstellationOverlayFlag = v; }, enumerable: true },
  enableIsolationFilterFlag: { get: () => enableIsolationFilterFlag, set: v => { enableIsolationFilterFlag = v; }, enumerable: true },
  enableDensityFilterFlag: { get: () => enableDensityFilterFlag, set: v => { enableDensityFilterFlag = v; }, enumerable: true },
  showCloudsFlag: { get: () => showCloudsFlag, set: v => { showCloudsFlag = v; }, enumerable: true },
  showCloudDensityFlag: { get: () => showCloudDensityFlag, set: v => { showCloudDensityFlag = v; }, enumerable: true },
  showGalacticPlaneFlag: { get: () => showGalacticPlaneFlag, set: v => { showGalacticPlaneFlag = v; }, enumerable: true },
  showEclipticPlaneFlag: { get: () => showEclipticPlaneFlag, set: v => { showEclipticPlaneFlag = v; }, enumerable: true },
  showCelestialEquatorFlag: { get: () => showCelestialEquatorFlag, set: v => { showCelestialEquatorFlag = v; }, enumerable: true }
});
